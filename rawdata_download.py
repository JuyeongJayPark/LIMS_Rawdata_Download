...
for TN_ID in TN_list:
    ...
    for run_info in run_info_list:
        ...
        output_bash.write(f"rsync -PLrvh --progress --partial {user}@qc1-120g:{run_info_path}/{TN_ID}*.gz ./{TN_ID}\n")
#        output_bash.write(f"scp {user}@qc1-120g:{run_info_path}/{TN_ID}*.gz ./{TN_ID}\n")
